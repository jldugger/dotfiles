...
(add-to-list 'auto-mode-alist '("\\.html.dj$" . django-html-mode))
(add-to-list 'auto-mode-alist '("\\.xml.dj$" . django-html-mode))
(add-to-list 'auto-mode-alist '("\\.dj.html$" . django-html-mode))
